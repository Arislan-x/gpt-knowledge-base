(() => {
  ...
  const TEXT = {
    zh: {
      ...
      deleteSelectedConfirm: "删除所选的 {count} 个浏览器备份？",
      deleteSelectedMixedConfirm: "删除所选的 {count} 个浏览器备份？外部文件夹中的 {external} 个会话不会被删除。",
      noSelectedConversations: "请先选择会话。",
      noDeletableSelectedConversations: "所选会话均来自外部文件夹，无法在工作站中删除。",
    ...
    en: {
      ...
      deleteSelectedConfirm: "Delete the {count} selected browser backups?",
      deleteSelectedMixedConfirm: "Delete the {count} selected browser backups? The {external} conversations from external folders will not be deleted.",
      noSelectedConversations: "Select at least one conversation first.",
      noDeletableSelectedConversations: "All selected conversations come from external folders and cannot be deleted in the workstation.",
