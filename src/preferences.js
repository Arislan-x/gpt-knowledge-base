(() => {
  ...
  const FONT_OPTIONS = [
    { key: "serif", label: "书卷衬线", labelEn: "Literary serif" },
    { key: "sans", label: "清爽无衬线", labelEn: "Clean sans" }
  ];
  ...
  const TEXT = {
    zh: {
      ...
      compatibilityNotice: "适配等级：ChatGPT、Claude、Gemini、Kimi 为完美级适配；豆包可获取较全信息，但不能良好复原；DeepSeek 当前只能获取模型信息。",
    ...
    en: {
      ...
      compatibilityNotice: "Compatibility: ChatGPT, Claude, Gemini, and Kimi are fully adapted; Doubao captures relatively complete data but cannot be faithfully reconstructed; DeepSeek currently captures model-side information only.",
